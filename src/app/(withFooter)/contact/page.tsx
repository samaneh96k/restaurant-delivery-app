                ...
                <div className="h-60 py-5 w-full flex flex-wrap justify-end">
                  <div className="flex flex-col py-2 w-full">
                    <Field
                      ...
                      id="name"
                      name="name"
                      className="bg-gray-200 w-full rounded-md p-1  text-dark px-4"
                      placeholder="name"
                    />
                    <ErrorMessage
                      name="name"
                  ...
                  <div className="flex flex-col py-2 w-full">
                    <Field
                      ...
                      id="email"
                        name="email"
                        placeholder="email"
                      className="bg-gray-200 rounded-md  p-1  text-dark px-4"
                    />
                    <ErrorMessage
                      name="email"
                      component="div"
                  ...
                  <div className="flex flex-col py-2 w-full">
                    ...
                    <div className=" bg-gradient-to-r from-primary-900 to-primary-600 my-2 p-1 text-white  xl:flex w-fit xl:justify-end">
