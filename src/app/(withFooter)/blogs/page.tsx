"use client";
import { useGetArticleQuery } from '@/storeRedux/services/aticleApi';
import Link from 'next/link'
import React from 'react'
import { useEffect } from 'react';

const OurBlogs = () => {
  const { isLoading, isFetching, data, error } = useGetArticleQuery(null);
      ...
      <div className="h-full w-full flex flex-wrap xl:mb-[10%]">
        ...
        <div className="aspect-w-4 aspect-h-1 ">
          ...
          />
              ...
              <Link href="/blogs/[articleId]" as={`/blogs/123`}>
              <div>
